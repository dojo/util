...
define(["dojo/json"], function() {
	var 
		...
		getPluginLayerText= function() {
			return cacheTemplate.replace("*1", this.pqn).replace("*2", this.path).replace("*3", this.filetype).replace("*4", dojo.json.stringify(this.module.text));
		},
